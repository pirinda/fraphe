...
echo '</div>';
echo '<div class="col-sm-8">';
echo '<label class="radio-inline small"><input type="radio" name="service_type" value="O"' . ($sample->getDatum("service_type") == ModRecept::SERVICE_ORDINARY ? ' checked' : '') . '>Ordinario</label>';
echo '<label class="radio-inline small"><input type="radio" name="service_type" value="U"' . ($sample->getDatum("service_type") == ModRecept::SERVICE_URGENT ? ' checked' : '') . '>Urgente</label>';
echo '</div>';
echo '</div>';
