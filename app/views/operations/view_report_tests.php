...
echo '<a href="' . $_SESSION[FAppConsts::ROOT_DIR_WEB] . 'app/views/operations/view_report.php" class="btn btn-info btn-sm" role="button">Volver</a>';
...
echo '<th>Límites permisibles</th>';
