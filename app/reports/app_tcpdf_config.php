 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', dirname(__FILE__).'/../images/tcpdf/');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'cedimi_header.jpg');

/**
 * Header logo image width in user units.
 */
define ('PDF_HEADER_LOGO_WIDTH', 540);
 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'CEDIMI Laboratorios');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Informe Resultados');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "CEDIMI Laboratorios\nwww.cedimi.com");
