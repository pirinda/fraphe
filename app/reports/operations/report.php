...
$pdf->writeHTMLCell(90, $hTxt09, '', '', $txt, 0, 0, false, 0, '', true);

$txt = "<b>Fecha emisión: </b>" . FLibUtils::formatLocDate($report->getDatum("ts_user_valid"));
$pdf->writeHTMLCell(90, $hTxt09, 94, '', $txt, 0, 1, false, 0, 'R', true);
...
$pdf->writeHTMLCell(60, $hTxt09, 62, '', $txt, 0, 0, false, 0, '', true);

$txt = "<b>Lote: </b>" . (empty($sample->getDatum("sample_lot")) ? "NE" : $sample->getDatum("sample_lot"));
$pdf->writeHTMLCell(60, $hTxt09, 124, '', $txt, 0, 1, false, 0, '', true);
...
$txt = "<b>T° muestreo: </b>" . (!isset($sample->getDatum("sampling_temperat_n")) ? "NE" : $sample->getDatum("sampling_temperat_n"));
$pdf->writeHTMLCell(45, $hTxt09, 47, '', $txt, 0, 0, false, 0, '', true);
...
$pdf->writeHTMLCell(45, $hTxt09, 94, '', $txt, 0, 0, false, 0, '', true);

$txt = "<b>Folio cadena: </b>" . (empty($sample->getDatum("ref_chain_custody")) ? "NE" : $sample->getDatum("ref_chain_custody"));
$pdf->writeHTMLCell(45, $hTxt09, 141, '', $txt, 0, 1, false, 0, '', true);
...
$pdf->writeHTMLCell(90, $hTxt09, 94, '', $txt, 0, 1, false, 0, '', true);
